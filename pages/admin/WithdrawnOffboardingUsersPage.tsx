...
interface WithdrawnOffboardingUsersPageProps {
  lang: 'EN' | 'TH';
}

const WithdrawnOffboardingUsersPage: React.FC<WithdrawnOffboardingUsersPageProps> = ({ lang }) => {
  const navigate = useNavigate();

  const t = {
    EN: {
      title: 'Withdrawn Offboarding Users',
      subtitle: 'Manage post-program access for offboarding users who are already WITHDRAWN.',
      back: 'Back to System Settings',
      empty: 'No withdrawn offboarding users',
      access: 'Access Level',
      retention: 'Retention',
    ...
    TH: {
      title: 'ผู้ใช้ที่ถอนตัว (Offboarding)',
      subtitle: 'จัดการสิทธิ์หลังจบโปรแกรมสำหรับผู้ใช้ที่เป็น WITHDRAWN จาก Offboarding',
      back: 'กลับไปตั้งค่าระบบ',
      empty: 'ไม่มีผู้ใช้ withdrawn แบบ offboarding',
...
export default WithdrawnOffboardingUsersPage;
